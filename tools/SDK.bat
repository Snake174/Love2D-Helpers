...
set PATH=%PATH%;%CD%\..\tools;%JAVA_HOME%;%JAVA_HOME%\bin
call %CD%\android-sdk-windows\tools\android.bat update sdk -u --all -t 1,2,19,29,38,94,95,108,112,113,125,145,149,150,151,152,153,154,156
